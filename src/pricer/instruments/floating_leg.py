...
class FloatingLegModel(BaseModel):
    """
    Modèle Pydantic pour valider les données d'une leg à taux variable avant création métier.
    """
...
class FloatingLeg(BaseLeg):
    """
    Jambe à taux variable.
    Utilise BaseLeg pour le schedule et crée des FloatingCoupon.
    """
